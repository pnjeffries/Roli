...
{
    /// <summary>
    /// A sub-component of a Data Binding which describes the source object and path
    /// </summary>
    [Serializable]
    public class SourceBinding : object
    {
        #region Properties
        ...
        /// <summary>
        /// Private backing field for the Owner property
        /// </summary>
        private DataBindingBase _Owner;

        /// <summary>
        /// The owning multibinding to which this part belongs
        /// </summary>
        public DataBindingBase Owner
        {
            get { return _Owner; }
            set { _Owner = value; }
        }
        ...
        public object SourceObject
        {
            get
            {
                ...
                else result = Owner?.GetComponentInParent<DataContext>()?.GetSourceObject();
        ...
        /// <returns></returns>
        public bool SetBoundValue(object value, IValueConverter converter = null)
        {
            if (_CachedSourceInfo == null && SourceObject != null)
            {
        ...
        {
            if (Source == null &&
                Owner?.GetComponentInParent<DataContext>()?.GetControllingDataContext() == context)
            {
        ...
        /// </summary>
        public virtual void CleanupOnDestroy()
        {
            // Clear old binding monitoring:
            if (BindingChain != null)
            {
