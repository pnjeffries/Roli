...
namespace Nucleus.Unity
{
    ...
    public class UnityMeshBuilder : MeshBuilderBase<UnityEngine.Mesh>
    {
        ...
        public override int AddFace(int v1, int v2, int v3)
        {
            ...
            if (DoubleSided)
            {
                _Triangles.Add(AddVertex(FromUnity.Convert(_Vertices[v1])));
                _Triangles.Add(AddVertex(FromUnity.Convert(_Vertices[v2])));
                _Triangles.Add(AddVertex(FromUnity.Convert(_Vertices[v3])));
            }
